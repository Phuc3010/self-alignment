...
accelerate launch --config_file recipes/accelerate_configs/multi_gpu.yaml --num_processes=2 --main_process_port 2950 scripts/run_spin.py recipes/pythia/pythia-1b/spin/config_full.yaml