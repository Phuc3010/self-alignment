...
python3 src/generate_vllm.py --model alignment-handbook/zephyr-7b-sft-full --input_dir generated/synthetic --frac_len 2000 --data_frac 0 --split test --output_dir generated/iter0 --world_size 8 
