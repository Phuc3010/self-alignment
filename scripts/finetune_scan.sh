...
epochs=("1", "2")
SCRIPT_COMMAND="ACCELERATE_LOG_LEVEL=info accelerate launch --config_file config/multi_gpu.yaml --num_processes=1 --main_process_port 2950 src/run_kto.py config/config.yaml --prior="
