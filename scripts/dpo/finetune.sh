...
accelerate launch --config_file recipes/accelerate_configs/multi_gpu.yaml --num_processes=2 scripts/run_sft.py recipes/pythia/pythia-1b/dpo/config_full.yaml
