...
class DataArguments:
    ...
    turn_type: Optional[str] = field(
        default=None, metadata={"help": "Multi-turn or Single-turn dialogue"}
    )
...
class KTOConfig(transformers.TrainingArguments):
    ...
    loss_type: Optional[str] = field(default="nnPU", metadata={"help": ("The loss type for KTO.")})
    prior: Optional[float] = field(default=0.5, metadata={"help": ("The class prior of PU learning")})