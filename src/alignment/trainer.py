...
class KTOTrainer(Trainer):
    ...
    def __init__(
        ...
        args: KTOConfig = None,
        loss_type: Literal["nnPU","kto_pair"] = "kto_pair",
        prior: float=0.5,
    ...
    def kto_loss(
        ...
        if self.loss_type == "nnpu":
            real_losses = self.prior*real_losses
            real_negative_losses = self.prior*(1-F.sigmoid(self.beta*(KL-real_logratios)))
            unlabeled_negative_losses = 1-F.sigmoid(self.beta*(KL-generated_logratios))
